 ...
 *
 * SVN $Revision: 7820 $
 * SVN $Date: 2015-09-16 18:09:47 +0530 (Wed, 16 Sep 2015) $
 */
/*=========================================================================*//**
  ...
  The watchdog driver functions are grouped into the following categories:
    - Initialization and c0nfiguration
  ...
  of the watchdog is reloaded. Attempting to reload the watchdog timer when its
  ...
  can be disabled by specifying an allowed refresh window equal or higher than
  ...
  disabled, the watchdog timer can only be re-enabled by a power-on reset.
  ...
  by the watchdog timer to wakeup the Cortex-M3 when the watchdog timer value
 ...
 * set the watchdog's operating mode within the watchdog's WDOGCONTROL register.
 */
...
/***************************************************************************//**
  ...
  Please note that the watchdog can only be re-enabled as a result of a power-on
  reset.
